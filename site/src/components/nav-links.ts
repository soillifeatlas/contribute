export interface NavLink { id: string; label: string; href: string; external: boolean; }
...
export function buildNavLinks(base: string): NavLink[] {
  ...
  return [
    ...
    { id: 'github', label: 'GitHub ↗', href: 'https://github.com/soillifeatlas/contribute', external: true },
